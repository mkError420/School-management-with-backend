    ...
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
      ...
      <div className="flex-1 flex gap-4 justify-between flex-wrap">
        ...
        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%] dark:bg-gray-700">
          ...
          <div className="">
            ...
            <span className="text=sm text-gray-500 dark:text-gray-300">Grade</span>
          </div>
        </div>
         {/* CARD */}
        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%] dark:bg-gray-700">
        ...
        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%] dark:bg-gray-700">
          ...
          <div className="">
            ...
            <span className="text=sm text-gray-500 dark:text-gray-300">Class</span>
          </div>
        </div>
      </div>
      </div>
      ...
      <div className="bg-white p-4 rounded-md dark:bg-gray-700">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
          <Link className="p-3 rounded-md bg-sky-300 dark:bg-sky-800" href="/">Student&apos;s Lessons</Link>
          <Link className="p-3 rounded-md bg-red-300 dark:bg-red-800" href="/">Student&apos;s Teachers</Link>
          <Link className="p-3 rounded-md bg-yellow-300 dark:bg-yellow-800" href="/">Student&apos;s Exams</Link>
          <Link className="p-3 rounded-md bg-pink-300 dark:bg-pink-800" href="/">Student&apos;s Assignments</Link>
          <Link className="p-3 rounded-md bg-purple-300 dark:bg-purple-800" href="/">Student&apos;s Results</Link>
        </div>
      </div>
      <Performance/>
      <Announcements/>
