...
const TeacherListPage = () => {      
  ...
  const renderRow=(item:Teacher)=>(
    <tr key={item.id} className="border-b border-gray-300 even:bg-slate-100 dark:even:bg-gray-800 text-xs hover:bg-purple-100 dark:hover:bg-gray-700">
      <td className="flex items-center gap-4 py-4 font-semibold">
        ...
        <td>
          <div className="flex items-center gap-2">
            ...
            {role ==="admin" && (
              //<button className="w-7 h-7 flex items-center justify-center rounded-full bg-purple-700">
