...
const FormModal = ({table,type,data,id}:{
  ...
  const bgColor = type === "create" ? "bg-cyan-400" : type=== 'update' ? "bg-sky-400" : "bg-purple-400";
    ...
    const Form = ()=>{
      ...
      <form action="" className="p-4 flex flex-col gap-4 ">
        <span className="text-center font-medium dark:text-black">You will loss this data 😦 !! Do you want to delete this {table}?</span>
  ...
  >
    ...
    {open && <div className="w-screen h-screen absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
      <div className="bg-white p-4 rounded-md relative w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%]2xl:w-[40%] dark:bg-gray-700">
        <Form/>
