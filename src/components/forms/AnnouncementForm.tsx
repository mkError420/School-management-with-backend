...
const AnnouncementForm = ({
  ...
  return <form className='flex flex-col gap-8' onSubmit={onSubmit}>
    <h1 className="text-xl font-semibold dark:text-white">Create a new Announcement</h1>
  ...
  />
    ...
    {errors?.sex?.message && (<p className="text-xs text-red-700">{errors.sex?.message.toString()}</p>
  )}
  </div>
